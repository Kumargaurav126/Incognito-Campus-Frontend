...
const Home = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-linear-to-br from-purple-900 via-indigo-900 to-gray-900 text-white font-sans flex flex-col items-center justify-center p-4 space-y-8">

            <h1 className="text-4xl font-bold mb-2 text-center bg-clip-text text-transparent bg-linear-to-r from-purple-400 to-pink-600">
